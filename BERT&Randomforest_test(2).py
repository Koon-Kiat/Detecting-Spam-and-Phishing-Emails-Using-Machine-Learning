...
def extract_bert_features_batch(texts, tokenizer, model, max_length, batch_size=16):
    features = []
...
if __name__ == "__main__":
    ...
    try:
        ...
        max_length = 128
        X_bert = extract_bert_features_batch(X, tokenizer, bert_model, max_length)
        ...
        #X_combined_reduced = pca.fit_transform(X_combined.toarray())
